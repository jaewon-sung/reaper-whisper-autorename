# -*- coding: utf-8 -*-
# @description Whisper STT + Excel Matcher Auto Renamer (Korean)
# @author Claude
# @version 2.1
...
def decompose_jamo(text):
    ...
    for ch in text:
        ...
        if 0xAC00 <= code <= 0xD7A3:
            ...
            jong = offset % 28
            CHO = [chr(c) for c in [0x3131,0x3132,0x3134,0x3137,0x3138,0x3139,0x3141,0x3142,0x3143,0x3145,0x3146,0x3147,0x3148,0x3149,0x314A,0x314B,0x314C,0x314D,0x314E]]
            JUNG = [chr(c) for c in [0x314F,0x3150,0x3151,0x3152,0x3153,0x3154,0x3155,0x3156,0x3157,0x3158,0x3159,0x315A,0x315B,0x315C,0x315D,0x315E,0x315F,0x3160,0x3161,0x3162,0x3163]]
            JONG = ['',chr(0x3131),chr(0x3132),chr(0x3133),chr(0x3134),chr(0x3135),chr(0x3136),chr(0x3137),chr(0x3139),chr(0x313A),chr(0x313B),chr(0x313C),chr(0x313D),chr(0x313E),chr(0x313F),chr(0x3140),chr(0x3141),chr(0x3142),chr(0x3144),chr(0x3145),chr(0x3146),chr(0x3147),chr(0x3148),chr(0x314A),chr(0x314B),chr(0x314C),chr(0x314D),chr(0x314E)]
...
def calculate_similarity(str1, str2):
    if not str1 or not str2:
        return 0.0
    s1 = decompose_jamo(unicodedata.normalize("NFC", str1).replace(" ", ""))
    s2 = decompose_jamo(unicodedata.normalize("NFC", str2).replace(" ", ""))
...
def main():
    ...
    RPR_ShowConsoleMsg("--- Whisper + Excel Auto-Rename [Korean] (Processing " + str(item_count) + " items) ---\n")
